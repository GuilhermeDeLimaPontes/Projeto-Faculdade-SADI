...
function Bubbles($titulo, $x, $y, $r = '2.5', $style = 'D') {
	$this->SetFont('Arial', 'B', 12);
	$this->Text($x-14, $y+1, "$titulo");
	$this->SetFont('Arial', '', 8);
	$this->Ellipse($x, $y, $r, $r, $style);
	$this->Text($x-0.9, $y+1, 'A');
	$x = $x+12;
	$this->Ellipse($x, $y, $r, $r, $style);
	$this->Text($x-0.9, $y+1, 'B');
	$x = $x+12;
	$this->Ellipse($x, $y, $r, $r, $style);
	$this->Text($x-0.9, $y+1, 'C');
	$x = $x+12;
	$this->Ellipse($x, $y, $r, $r, $style);
	$this->Text($x-0.9, $y+1, 'D');
	$this->SetDrawColor(200, 200, 200);
	$this->Line($x-54, $y+5.5, $x+9, $y+5.5);
